...
if(isset($_GET["id"])){
    ...
    $reservations = get_reservation_nuitee_by_added_by($connexion, $user_id, $perPage, $offset, $keyword, $date, $mois);

    // Récupérer le nombre total de réservations pour la pagination
    $totalReservations = get_total_reservations_nuitee($connexion, $user_id, $keyword, $date, $mois);
