...
$clients_products = null;

if (isset($_GET["uuid"])) {
    $uuid = $_GET["uuid"];

    $stmt = $connexion->prepare("SELECT * FROM client_products WHERE uuid = :uuid AND is_deleted = 0");
    $stmt->execute([':uuid' => $uuid]);
    $clients_products = $stmt->fetch(PDO::FETCH_ASSOC);
}
?>
<div class="main-container mt-3 pb-5">
    ...
    <div class="col-lg-8 col-sm-12 mb-3 mx-auto">
        <div class="card shadow border-0 rounded-0 p-4">
            ...
            <h5 class="mb-4 text-uppercase">📦 Préparation de la livraison du produit <?= htmlspecialchars($clients_products['ref']) ?> </h5>
            ...
            <form method="post" class="needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="shadow-none form-control select-custom" id="delivery_man" name="delivery_man_id" required>
                ...
                <!-- <div class="col-lg-4 col-sm-12 mb-3">
                    ...
                    <?php if ($clients_products['product_image']): ?>
                        <img src="../uploads/products/<?= htmlspecialchars($clients_products['product_image']) ?>" alt="Photo agent" style="max-width:150px;">
                    <?php else: ?>
                        <p>Aucune photo</p>
                    <?php endif; ?>
                </div> -->
