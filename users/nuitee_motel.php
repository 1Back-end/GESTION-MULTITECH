...
<div class="main-container mt-3 pb-5">
    ...
    <div class="card-box p-3">
        <div class="d-flex align-items-center justify-content-between">
            <div class="mr-auto">
            <?php if ($motels_name): ?>
        <h5 class="text-uppercase">Bienvenue aux nuitées de la <?php echo htmlspecialchars($motels_name); ?></h5>
    <?php else: ?>
        <h4 class="text-uppercase">Aucun motel assigné.</h4>
    <?php endif; ?>
            </div>
            <div class="ml-auto">
                <a href="add_nuite.php" class="btn btn-customize text-white text-uppercase">
...
$reservations = get_reservation_by_motel_nuite_id_and_added_by($connexion, $motel_id, $user_id, $perPage, $offset);
